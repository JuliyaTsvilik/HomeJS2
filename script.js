...
// Дан объект user. Используя данные из объекта, сформировать строку в формате: ‘User’s name is <FIRST_NAME> <LAST_NAME>. 
// He is <AGE> years old’
...
// }
    ...
    const user = {
      ...
      const result =` User's name is ${user.first_name} ${user.last_name}. He is ${user.age} years old.`;
